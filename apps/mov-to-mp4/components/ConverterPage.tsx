...
export default function ConverterPage({ hubUrl = "/" }: Props) {
  ...
  return (
    <div style={s.root}>
      ...
      <div style={s.inner}>
            ...
            >
              ...
              >
                <div
                  style={{
                    height: "100%",
                    background: "linear-gradient(90deg, #7c3aff, #3b82f6)",
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    background: "linear-gradient(135deg, #7c3aff, #3b82f6)",
                    color: "white",
                    textDecoration: "none",
                    padding: "14px 36px",
                    borderRadius: "2px",
        ...
        >
          <a href={hubUrl} style={{ color: "inherit", textDecoration: "none" }}>
            toolbox
          </a>
